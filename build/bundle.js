...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginViewJs = __webpack_require__(157);

	var _loginViewJs2 = _interopRequireDefault(_loginViewJs);

	main();

	function main() {
	    _react2['default'].render(_react2['default'].createElement(_loginViewJs2['default'], null), document.getElementById('app'));
	}
